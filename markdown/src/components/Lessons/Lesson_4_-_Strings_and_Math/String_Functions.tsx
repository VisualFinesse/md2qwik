...
export const String_Functions = component$(() => {
  return (
    <div innerHTML={'<p>Words, phrases, or sentences often need to be constructed programmatically. To do this, built-in functions are used to manipulate strings in ways that would normally need extensive looping logic. </p>
