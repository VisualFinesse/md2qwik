...
export const If_Statements = component$(() => {
  return (
    <div innerHTML={'<p>If statements are control flow structures that perform logic conditionally based on a [[Booleans|boolean]] value provided to them. If statements will only execute the code in their body if the condition provided to it evaluates to <strong>true</strong>.</p>
